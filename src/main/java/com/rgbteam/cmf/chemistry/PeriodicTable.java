...
public class PeriodicTable {
    private static final Element[] TABLE = {
            new Element("H", "Hydrogen", 1, "Nonmetals", 1.008, new int[]{1}, new int[]{+1, -1}),
            ...
            new Element("C", "Carbon", 6, "Nonmetals", 12.011, new int[]{4}, new int[]{-4, 0, +2, +4}),
            new Element("N", "Nitrogen", 7, "Nonmetals", 14.007, new int[]{3}, new int[]{-3, -2, -1, +1, +2, +3, +4, +5}),
            new Element("O", "Oxygen", 8, "Nonmetals", 15.999, new int[]{2}, new int[]{-2, -1, 0, +1, +2}),
            ...
            new Element("Te", "Tellurium", 52, "Nonmetals", 127.60, new int[]{2}, new int[]{-2, +4, +6}),
